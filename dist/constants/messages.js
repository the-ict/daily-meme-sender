...
`;
const etc_start = (ctx) => `👋 <b>Yana salom, ${ctx.message?.from.first_name || ctx.message?.from.last_name || "do'stim"}!</b>\n\n` +
...
const first_start = (ctx) => `👋 <b>Salom, ${ctx.message?.from.first_name || "do'stim"}!</b>\n\n` +
